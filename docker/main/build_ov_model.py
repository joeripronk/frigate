...
try:
    ...
    def build_motion_model_main(
        ...
        h, w = frame_shape
        frame_input = ops.parameter(ov.Type.u8, ie_shape=ov.PartialShape([1, h, w, 1]), name="frame_input")
        avg_frame_input = ops.parameter(ov.Type.f32, ie_shape=ov.PartialShape([h, w]), name="avg_frame_input")
